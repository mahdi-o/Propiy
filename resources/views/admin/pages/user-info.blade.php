...
@section('content')
    ...
    <div class="bg-blue-500 mx-auto py-20 px-5 rounded-2xl w-full">
        ...
        <!-- Start Row 3 -->
        <div class="gb-white w-full py-4">
            ...
            <div class="flex flex-wrap -mx-3 ">
                ...
                <div class="w-full max-w-full px-3 shrink-0 md:w-full md:flex-0 items-center justify-center text-right">
                    <button type="button"
                        class="inline-block px-8 py-2 mb-4 ml-auto font-bold leading-normal text-center text-white align-middle transition-all ease-in bg-rose-500 border-0 rounded-lg shadow-md cursor-pointer text-xs tracking-tight-rem hover:shadow-xs hover:-translate-y-px active:opacity-85">Settings</button>
                </div>
