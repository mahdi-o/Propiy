...
@section('content')
    <div class="flex flex-col gap-10 bg-white dark:bg-slate-850 dark:shadow-dark-xl mx-auto py-5 px-7 rounded-2xl w-full">
        ...
        <div class="flex flex-row">
            <div class="">
                ...
                <div class="flex flex-row gap-5">
                    <div id="one">
                        <input  id="customInput" type="text" class="text-black border border-gray-700 dark:text-white dark:focus:border-orange-500 focus:border-orange-500 hover:border-orange-500
                          focus:ring-0 outline-none rounded-lg w-70 h-9 px-3" placeholder="Account Number" value="Account Number">
                            ...
                            class="w-full px-2 py-1 h-9 border text-center justify-center items-center border-gray-700 active:border-orange-500 focus:border-orange-500 hover:border-orange-500 rounded-lg
                             ...
                             <div class="flex flex-row justify-between text-center items-center">
                              <div class="flex flex-row justify-start items-start">
                                ...
                                <svg class="h-8 w-8 text-gray-900 pb-3"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M18 15l-6-6l-6 6h12" transform="rotate(180 12 12)" /></svg>
                             </div>
                        </summary>
        
                        <ul class="flex flex-col gap-1 px-2 py-3 absolute left-0 right-0 mt-2 border border-gray-300 bg-white text-gray-900 rounded-md shadow-md z-10">
                            <li class="px-2 py-1 hover:bg-orange-100 cursor-pointer overflow-hidden transition-all duration-500 rounded-md">All</li>
                            <li class="px-2 py-1 hover:bg-orange-100 cursor-pointer overflow-hidden transition-all duration-500 rounded-md">Two-Step</li>
                            <li class="px-2 py-1 hover:bg-orange-100 cursor-pointer overflow-hidden transition-all duration-500 rounded-md">Jet Jump</li>
                        </ul>    
                    </details>
                   </div>
                    ...
                    <details class="relative w-55 details-open transition-all duration-500">
                        <summary
                            class="w-full px-2 py-1 h-9 border text-center justify-center items-center border-gray-700 active:border-orange-500 focus:border-orange-500 hover:border-orange-500 rounded-lg
                             ...
                             <div class="flex flex-row justify-between text-center items-center">
                              <div class="flex flex-row justify-start items-start">
                                <svg class="h-10 w-10 text-gray-700 pb-3"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <circle cx="5" cy="12" r="1" />  <circle cx="12" cy="12" r="1" />  <circle cx="19" cy="12" r="1" /></svg>
                                <p>
                                    Status
                                </p>
                              </div>
        ...
        <div class="w-full rounded-xl shadow space-y-2">
            <!-- Table Head Wrapper -->
            <div class="rounded-xl border border-gray-100 bg-gray-50 dark:bg-slate-850 dark:shadow-dark-xl overflow-hidden">
              <table class="w-full text-left">
                <thead>
                  <tr class="text-gray-800 dark:text-white text-sm">
                ...
                <tbody>
                  <tr>
                    <td colspan="8" class="text-center px-4 py-10 text-gray-500 dark:text-gray-400">
                      <img src="{{ asset('assets/img/site/challenge-empty.png') }}" alt="Empty" class="mx-auto w-48 mb-4">
                      ...
                      <p class="mb-6 text-sm leading-relaxed">
                        ...
                        And if you have not yet completed identity verification, make sure to complete the process.
                      </p>
                      <div class="flex justify-center gap-4">
                        <button class="flex items-center gap-2 bg-orange-500 text-white font-medium px-4 py-1 rounded-lg transition duration-150">
                            ...
                            <button class="px-4 py-1 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-700 dark:text-gray-300 hover:border-orange-500 hover:text-orange-500 dark:hover:bg-gray-800 transition">
                                Authentication
                              </button>
